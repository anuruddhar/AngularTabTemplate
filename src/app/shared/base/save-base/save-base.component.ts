...
export class SaveBaseComponent<T extends TabFormViewModel> extends BaseComponent<T> {
  ...
  constructor(
    ...
    this.ActionMenuItems.push({ Id: 1, Icon: 'fa fa-floppy-o', ToolTipText: 'Save', Class: '' });
  }
